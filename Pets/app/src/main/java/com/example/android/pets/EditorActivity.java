...
public class EditorActivity extends AppCompatActivity {
    ...
    private void insertPet() {
        ...
        values.put(COLUMN_PET_WEIGHT, mWeight);

        Uri insertUri = getContentResolver().insert(CONTENT_URI, values);

        if(insertUri == null){
            Toast.makeText(this, R.string.ToastFail, Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(this, R.string.ToastSuccess, Toast.LENGTH_SHORT).show();
        }
    }
}